...
class SummaryMetaBox {
	...
	public static function render_meta_box( \WP_Post $post ): void {
			...
			echo '<p><button type="button" class="button" id="wpai-generate-summary" data-post-id="' . esc_attr( (string) ( $post->ID ) ) . '">' . esc_html__( 'Generate summary', 'wp-ai-assistant' ) . '</button></p>';
	}
}
